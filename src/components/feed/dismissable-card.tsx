    ...
    <div className={`group relative overflow-hidden ${className ?? ""}`}>
      ...
      >
        ...
        <button
          ...
          className="absolute top-2 right-2 z-10 hidden rounded-full border border-border bg-surface/90 p-1 text-text-dim opacity-0 backdrop-blur-sm transition-opacity hover:text-text group-hover:opacity-100 lg:flex"
        >
